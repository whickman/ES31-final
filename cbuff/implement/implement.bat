...
xst -ifn xst.scr
move cbuff_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\cbuff_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc cbuff_exdes.ucf cbuff_exdes

echo 'Running map'
map -timing -pr b cbuff_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm cbuff_exdes -w routed.ncd routed.vhd
cd ..
